    ...
    <div className="grid grid-rows-[auto_1fr_auto] min-h-screen bg-white font-[Prompt]">
      ...
      <main className="flex flex-col items-center px-4 py-12 max-w-7xl mx-auto w-full">
        ...
        <div className="relative w-full rounded-3xl overflow-hidden min-h-[850px] flex flex-col items-center justify-center">
          ...
          {/* การ์ด 6 ใบแรก */}
          <div className="relative justify-items-center mx-10 sm:mx-0 z-10 grid grid-cols-1 sm:grid-cols-2 pt-10 sm:pt-0 gap-6 w-fit px-8">
          ...
          {cardData.length > 6 && (
            <div className="relative mx-10 sm:mx-0 z-10 mt-6 flex justify-center w-full pb-10 sm:pt-0">
